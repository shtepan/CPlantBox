...
name = ["Zea_mays_4_Leitner_2014", "Pisum_sativum_a_Pages_2020_test"]

simtime = 120
N = 2  # number of columns
R = 1   # and rows
dist = 50  # distance between the root systems [cm]
...
ana.write("results/example_1d_all_LAB_11Aug2020).vtp")
